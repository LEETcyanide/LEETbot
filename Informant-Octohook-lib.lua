...
Edited by xz#1111
Formatted for LEETbot by LEETcyanide
]]
...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddSeparator({text = 'LEETbot and Library'});
    creditsSection:AddText({text = "LEETcyanide - LEETbot"})
    creditsSection:AddText({text = "xz#1111 - Library"})
    creditsSection:AddText({text = "goof#1000 - Library"})
    ...
    mainSection:AddButton({text = 'Copy Discord', flag = 'copydiscord', callback = function()
        setclipboard('https://discord.gg/PikachuHub')
    end})
    ...
    mainSection:AddButton({text = 'Destroy LEETbot', confirm = true, callback = function()
        library:Unload();
    end})
